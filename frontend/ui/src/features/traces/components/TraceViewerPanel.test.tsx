...
describe("TraceViewerPanel detectors view", () => {
  ...
  it("keeps the AI panel reachable on the detectors view", () => {
    // The AI panel is a top-level sibling of the main content, so the detectors
    // overlay (which covers only the main panel) never hides it — the agent
    // stays usable on the Detectors tab.
